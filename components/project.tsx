...
const Project = ({ title, description, tags, imageUrl }: Props) => {
  ...
  return (
    ...
    >
      <section className="border-dim relative max-w-[42rem] overflow-hidden rounded-lg bg-gray-100 transition hover:bg-gray-200 dark:bg-white/10 dark:text-white dark:hover:bg-white/20 sm:h-[20rem] sm:pr-8 sm:group-even:pl-8">
        ...
        <Image
          className="absolute -right-40 top-8 hidden w-[28.25rem] rounded-t-lg shadow-2xl transition group-even:-left-40 group-even:right-[initial] 
